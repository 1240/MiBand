...
import static ru.l240.miband.gadgetbridge.devices.miband.MiBandConst.PREF_MIBAND_ALARMS;
...
public class GBAlarm implements Alarm {
    ...
    public void store() {
        SharedPreferences sharedPrefs = PreferenceManager.getDefaultSharedPreferences(MiApplication.getContext());
